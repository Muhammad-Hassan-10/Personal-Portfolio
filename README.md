...
- Live preview: open `index.html` in your browser to view the site locally. or visit: https://mh-personal-portfolio.netlify.app/
...
1. Clone the repo (if not already):
   ...
   ```bash
   git clone https://github.com/Muhammad-Hassan-10/Personal-Portfolio
   ```
...
- LinkedIn: https://www.linkedin.com/in/muhammad-hassan-68b148380/
